                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="p-4 border border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-xl">
                                <span className="text-xs font-bold text-[#666] mb-2 block">Quick Install</span>
                    ...
                    <div className="lg:col-span-7">
                        <div className="border border-black bg-[#1a1a1a] text-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative rounded-xl">
                            {/* Window Actions */}
