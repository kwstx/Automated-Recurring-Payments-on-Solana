                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-3">
                        <div className="mb-12">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold mb-6">Subscriptions</h1>
                        ...
                        <div className="prose max-w-none font-mono text-sm leading-7">
                            <h3 className="text-xl font-bold mb-4 font-sans">Lifecycle</h3>
                            ...
                            <h3 className="text-xl font-bold mb-4 font-sans">PDA Structure</h3>
                            <p className="mb-4">
