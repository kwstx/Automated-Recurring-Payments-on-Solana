                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="prose max-w-none font-mono text-sm leading-7">
                            <h3 className="text-xl font-bold mb-4 font-sans">Prerequisites</h3>
                            ...
                            <h3 className="text-xl font-bold mb-4 font-sans">Frontend SDK</h3>
                            <p className="mb-4">
                            ...
                            <h3 className="text-xl font-bold mb-4 font-sans">Backend / Bot SDK</h3>
                            <p className="mb-4">
