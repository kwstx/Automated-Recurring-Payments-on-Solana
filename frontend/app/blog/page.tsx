        ...
        <div className="min-h-screen bg-[#F5F5F5] text-black font-sans">
            ...
            <main className="max-w-[1920px] mx-auto px-4 md:px-6 py-24">
                <div className="max-w-5xl mx-auto">
                    <span className="text-xs font-mono font-bold mb-6 block text-[#666]">BLOG</span>
                    <h1 className="text-4xl md:text-6xl font-bold leading-[0.9] mb-20">
                        LATEST<br />UPDATES
                    </h1>
                        ...
                        {BLOG_POSTS.map((post) => (
                            <Link key={post.slug} href={`/blog/${post.slug}`} className="group block">
                                <article className="border-b border-black pb-12">
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-bold mb-4 group-hover:underline decoration-4 decoration-black">{post.title}</h2>
