        ...
        <div className="min-h-screen bg-[#F5F5F5] text-black font-sans">
            ...
            <main className="max-w-[1920px] mx-auto px-4 md:px-6 py-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                    <div>
                        <span className="text-xs font-mono font-bold mb-6 block text-[#666]">CONTACT</span>
                    ...
                    <div className="bg-white border border-black p-8 md:p-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                        <form className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-mono font-bold text-[#666]">Subject</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-mono font-bold text-[#666]">Message</label>
                                <textarea
                                    rows={4}
                            ...
                            <button className="w-full bg-black text-white py-4 font-bold hover:bg-[#333] transition-colors mt-4">
                                Send Message
                            </button>
                        </form>
                    </div>
