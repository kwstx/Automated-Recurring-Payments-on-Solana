        ...
        <div className="min-h-screen bg-[#F5F5F5] text-black font-sans">
            ...
            <main className="max-w-[1920px] mx-auto px-4 md:px-6 py-24">
                <div className="max-w-4xl mx-auto">
                    <span className="text-xs font-mono font-bold mb-6 block text-[#666]">COMPANY</span>
                    ...
                    <div className="prose max-w-none font-mono text-sm leading-8 text-[#333]">
                        <p className="mb-8 text-xl md:text-2xl font-bold font-sans text-black leading-tight">
                    ...
                    <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-black pt-12">
                        <div>
                            ...
                            <span className="text-xs font-mono text-[#666]">Mainnet Status</span>
                        </div>
                        <div>
                            <span className="block text-4xl font-bold mb-2">Pilot</span>
                            <span className="text-xs font-mono text-[#666]">Program Access</span>
                        </div>
                        <div>
                            <span className="block text-4xl font-bold mb-2">99.9%</span>
                            <span className="text-xs font-mono text-[#666]">Uptime Target</span>
                        </div>
                        <div>
                            <span className="block text-4xl font-bold mb-2">0%</span>
                            <span className="text-xs font-mono text-[#666]">Platform Fees</span>
                        </div>
                    </div>
                </div>
            </main>
