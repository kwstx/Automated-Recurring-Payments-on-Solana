    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createPlan.mutateAsync({
                ...
                amount: parseFloat(formData.price) * 1000000, // Convert to USDC atomic units (6 decimals)
                currency: 'USDC',
            ...
            >
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Price */}
                        <div className="border border-[#a3a3a3] bg-white p-8">
                            <label className="block text-xs font-mono font-bold text-black uppercase mb-2">Price (USDC)</label>
                            <div className="flex items-center gap-3">
                    ...
                    <div className="p-6 border-2 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <div className="flex justify-between text-xs font-mono font-bold uppercase py-2 border-b border-[#EAEAEA]">
                                ...
                                <span className="text-black text-lg tracking-tight">{formData.price ? `$${formData.price}` : '-'} <span className="text-xs text-[#999]">USDC</span></span>
                            </div>
                        </div>
